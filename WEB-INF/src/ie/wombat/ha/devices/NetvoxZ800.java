 ...
 *
 */
public class NetvoxZ800 extends DeviceDriver implements Relay, HeatingDevice {

	private Logger log = Logger.getLogger (NetvoxZ800.class);
	
	public NetvoxZ800(Address64 address64, Address16 address16, ZigBeeNIC nic) {
